...
public class ProfiledPIDCommand extends CommandBase {
    ...
    public ProfiledPIDCommand(@NonNull ProfiledPIDController controller, @NonNull DoubleSupplier measurementSource,
                              @NonNull Supplier<TrapezoidProfile.State> goalSource, @NonNull BiConsumer<Double, TrapezoidProfile.State> useOutput,
     ...
     */
    public ProfiledPIDCommand(@NonNull ProfiledPIDController controller, @NonNull DoubleSupplier measurementSource,
                              @NonNull DoubleSupplier goalSource, @NonNull BiConsumer<Double, TrapezoidProfile.State> useOutput,
                              Subsystem... requirements) {
    ...
    public ProfiledPIDCommand(ProfiledPIDController controller, DoubleSupplier measurementSource,
                              TrapezoidProfile.State goal, BiConsumer<Double, TrapezoidProfile.State> useOutput,
                              Subsystem... requirements) {
     ...
     */
    public ProfiledPIDCommand(ProfiledPIDController controller, DoubleSupplier measurementSource,
                              double goal, BiConsumer<Double, TrapezoidProfile.State> useOutput,
                              Subsystem... requirements) {
        this(controller, measurementSource, () -> goal, useOutput, requirements);
    }
