...
public class RobotHardware {
    ...
    //swerve
    private DcMotorEx motorFrontRight, motorFrontLeft, motorBackRight, motorBackLeft;
    private CRServo servoFrontRight, servoFrontLeft, servoBackRight, servoBackLeft;
    private absoluteAnalogEncoder encoderFrontRight, encoderFrontLeft, encoderBackLeft, encoderBackRight;
