...
public class GamepadEx {
    ...
    private HashMap<Button, com.arcrobotics.ftclib.gamepad.ButtonReader> buttonReaders;
    ...
    public GamepadEx(Gamepad gamepad) {
        ...
        for (Button button : buttons) {
            buttonReaders.put(button, new com.arcrobotics.ftclib.gamepad.ButtonReader(this, button));
