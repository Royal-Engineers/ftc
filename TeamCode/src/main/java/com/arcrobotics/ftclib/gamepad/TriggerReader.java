...
public class TriggerReader implements KeyReader {
    ...
    private com.arcrobotics.ftclib.gamepad.GamepadEx gamepad;

    private com.arcrobotics.ftclib.gamepad.GamepadKeys.Trigger trigger;
     ...
     **/
    public TriggerReader(com.arcrobotics.ftclib.gamepad.GamepadEx gamepad, com.arcrobotics.ftclib.gamepad.GamepadKeys.Trigger trigger) {
