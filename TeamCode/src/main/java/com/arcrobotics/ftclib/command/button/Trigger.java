 ...
 * reading a certain sensor input). For this, they only have to write the {@link com.arcrobotics.ftclib.command.button.Trigger#get()}
...
public class Trigger {
     ...
     * subclasses that will be overriding {@link com.arcrobotics.ftclib.command.button.Trigger#get()} anyway.
     */
    public Trigger() {
        m_isActive = () -> false;
    }
     ...
     */
    public com.arcrobotics.ftclib.command.button.Trigger whenActive(final Command command, boolean interruptible) {
     ...
     * @return this trigger, so calls can be chained
     */
    public com.arcrobotics.ftclib.command.button.Trigger whenActive(final Command command) {
     ...
     * @return this trigger, so calls can be chained
     */
    public com.arcrobotics.ftclib.command.button.Trigger whenActive(final Runnable toRun) {
     ...
     * @return this trigger, so calls can be chained
     */
    public com.arcrobotics.ftclib.command.button.Trigger whileActiveContinuous(final Command command, boolean interruptible) {
        CommandScheduler.getInstance().addButton(new Runnable() {
            private boolean m_pressedLast = get();
     ...
     * @return this trigger, so calls can be chained
     */
    public com.arcrobotics.ftclib.command.button.Trigger whileActiveContinuous(final Command command) {
     ...
     * @return this trigger, so calls can be chained
     */
    public com.arcrobotics.ftclib.command.button.Trigger whileActiveContinuous(final Runnable toRun) {
     ...
     * @return this trigger, so calls can be chained
     */
    public com.arcrobotics.ftclib.command.button.Trigger whileActiveOnce(final Command command, boolean interruptible) {
        CommandScheduler.getInstance().addButton(new Runnable() {
            private boolean m_pressedLast = get();
     ...
     * @return this trigger, so calls can be chained
     */
    public com.arcrobotics.ftclib.command.button.Trigger whileActiveOnce(final Command command) {
     ...
     * @return this trigger, so calls can be chained
     */
    public com.arcrobotics.ftclib.command.button.Trigger whenInactive(final Command command, boolean interruptible) {
        CommandScheduler.getInstance().addButton(new Runnable() {
            private boolean m_pressedLast = get();
     ...
     * @return this trigger, so calls can be chained
     */
    public com.arcrobotics.ftclib.command.button.Trigger whenInactive(final Command command) {
     ...
     * @return this trigger, so calls can be chained
     */
    public com.arcrobotics.ftclib.command.button.Trigger whenInactive(final Runnable toRun) {
     ...
     * @return this trigger, so calls can be chained
     */
    public com.arcrobotics.ftclib.command.button.Trigger toggleWhenActive(final Command command, boolean interruptible) {
        CommandScheduler.getInstance().addButton(new Runnable() {
            private boolean m_pressedLast = get();
     ...
     * @return this trigger, so calls can be chained
     */
    public com.arcrobotics.ftclib.command.button.Trigger toggleWhenActive(final Command command) {
     ...
     * @return this trigger, so calls can be chained
     */
    public com.arcrobotics.ftclib.command.button.Trigger toggleWhenActive(final Command commandOne, final Command commandTwo, boolean interruptible) {
        CommandScheduler.getInstance().addButton(new Runnable() {
            private boolean m_pressedLast = get();
     ...
     * @return this trigger, so calls can be chained
     */
    public com.arcrobotics.ftclib.command.button.Trigger toggleWhenActive(final Command commandOne, final Command commandTwo) {
     ...
     * @return this trigger, so calls can be chained
     */
    public com.arcrobotics.ftclib.command.button.Trigger toggleWhenActive(final Runnable runnableOne, final Runnable runnableTwo) {
     ...
     * @return this trigger, so calls can be chained
     */
    public com.arcrobotics.ftclib.command.button.Trigger cancelWhenActive(final Command command) {
        CommandScheduler.getInstance().addButton(new Runnable() {
            private boolean m_pressedLast = get();
     ...
     */
    public com.arcrobotics.ftclib.command.button.Trigger and(com.arcrobotics.ftclib.command.button.Trigger trigger) {
        return new com.arcrobotics.ftclib.command.button.Trigger(() -> get() && trigger.get());
    }
     ...
     */
    public com.arcrobotics.ftclib.command.button.Trigger or(com.arcrobotics.ftclib.command.button.Trigger trigger) {
        return new com.arcrobotics.ftclib.command.button.Trigger(() -> get() || trigger.get());
    }
     ...
     */
    public com.arcrobotics.ftclib.command.button.Trigger negate() {
        return new com.arcrobotics.ftclib.command.button.Trigger(() -> !get());
    }
