...
public class SelectCommand extends CommandBase {
    private final Map<Object, com.arcrobotics.ftclib.command.Command> m_commands;
    private final Supplier<Object> m_selector;
    private final Supplier<com.arcrobotics.ftclib.command.Command> m_toRun;
    private com.arcrobotics.ftclib.command.Command m_selectedCommand;
     ...
     */
    public SelectCommand(@NonNull Map<Object, com.arcrobotics.ftclib.command.Command> commands, @NonNull Supplier<Object> selector) {
        CommandGroupBase.registerGroupedCommands(commands.values().toArray(new com.arcrobotics.ftclib.command.Command[]{}));
        ...
        for (com.arcrobotics.ftclib.command.Command command : m_commands.values()) {
     ...
     */
    public SelectCommand(@NonNull Supplier<com.arcrobotics.ftclib.command.Command> toRun) {
        m_commands = null;
        m_selector = null;
