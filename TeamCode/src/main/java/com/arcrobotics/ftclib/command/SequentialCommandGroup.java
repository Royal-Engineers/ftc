...
public class SequentialCommandGroup extends CommandGroupBase {
    ...
    private final List<com.arcrobotics.ftclib.command.Command> m_commands = new ArrayList<>();
     ...
     */
    public SequentialCommandGroup(com.arcrobotics.ftclib.command.Command... commands) {
