...
public class ParallelRaceGroup extends CommandGroupBase {
    ...
    private final Set<com.arcrobotics.ftclib.command.Command> m_commands = new HashSet<>();
     ...
     */
    public ParallelRaceGroup(com.arcrobotics.ftclib.command.Command... commands) {
    ...
    public void initialize() {
        m_finished = false;
        for (com.arcrobotics.ftclib.command.Command command : m_commands) {
            command.initialize();
        }
    }
