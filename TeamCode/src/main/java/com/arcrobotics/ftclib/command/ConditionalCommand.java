...
public class ConditionalCommand extends CommandBase {
    ...
    private final com.arcrobotics.ftclib.command.Command m_onTrue;
    private final com.arcrobotics.ftclib.command.Command m_onFalse;
     ...
     */
    public ConditionalCommand(com.arcrobotics.ftclib.command.Command onTrue, Command onFalse, BooleanSupplier condition) {
