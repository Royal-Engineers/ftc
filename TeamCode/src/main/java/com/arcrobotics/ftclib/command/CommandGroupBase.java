 ...
 * @author Jackson
 */
public abstract class CommandGroupBase extends CommandBase implements com.arcrobotics.ftclib.command.Command {

    private static final Set<com.arcrobotics.ftclib.command.Command> m_groupedCommands =
            Collections.newSetFromMap(new WeakHashMap<>());

    static void registerGroupedCommands(com.arcrobotics.ftclib.command.Command... commands) {
     ...
     */
    public static void clearGroupedCommand(com.arcrobotics.ftclib.command.Command command) {
     ...
     */
    public static void requireUngrouped(com.arcrobotics.ftclib.command.Command... commands) {
     ...
     * @param commands The commands to check
     */
    public static void requireUngrouped(Collection<com.arcrobotics.ftclib.command.Command> commands) {
    ...
    static Set<com.arcrobotics.ftclib.command.Command> getGroupedCommands() {
