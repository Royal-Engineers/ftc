...
public class ParallelCommandGroup extends CommandGroupBase {
     ...
     */
    public ParallelCommandGroup(com.arcrobotics.ftclib.command.Command... commands) {
        addCommands(commands);
    }

    @Override
    public final void addCommands(com.arcrobotics.ftclib.command.Command... commands) {
