 ...
 * run by the {@link com.arcrobotics.ftclib.command.CommandScheduler}, and can be composed into CommandGroups to allow users to
...
public interface Command {
     ...
     */
    Set<com.arcrobotics.ftclib.command.Subsystem> getRequirements();
     ...
     * {@link com.arcrobotics.ftclib.command.CommandGroupBase#clearGroupedCommand(com.arcrobotics.ftclib.command.Command)}.  The decorated command can, however, be
     * further decorated without issue.
     *
     * @param millis the timeout duration
     * @return the command with the timeout added
     */
    default com.arcrobotics.ftclib.command.Command withTimeout(long millis) {
        return new com.arcrobotics.ftclib.command.ParallelRaceGroup(this, new WaitCommand(millis));
    }
     ...
     */
    default com.arcrobotics.ftclib.command.Command interruptOn(BooleanSupplier condition) {
        return new com.arcrobotics.ftclib.command.ParallelRaceGroup(this, new WaitUntilCommand(condition));
    }
     ...
     */
    default com.arcrobotics.ftclib.command.Command whenFinished(Runnable toRun) {
        return new com.arcrobotics.ftclib.command.SequentialCommandGroup(this, new com.arcrobotics.ftclib.command.InstantCommand(toRun));
    }
     ...
     * @return the decorated command
     */
    default com.arcrobotics.ftclib.command.Command beforeStarting(Runnable toRun) {
        return new com.arcrobotics.ftclib.command.SequentialCommandGroup(new InstantCommand(toRun), this);
    }

    /**
     * Decorates this command with a set of commands to run after it in sequence.  Often more
     * convenient/less-verbose than constructing a new {@link com.arcrobotics.ftclib.command.SequentialCommandGroup} explicitly.
     *
     * <p>Note: This decorator works by composing this command within a CommandGroup.  The command
     * cannot be used independently after being decorated, or be re-decorated with a different
     * decorator, unless it is manually cleared from the list of grouped commands with
     ...
     * @return the decorated command
     */
    default com.arcrobotics.ftclib.command.Command andThen(com.arcrobotics.ftclib.command.Command... next) {
        com.arcrobotics.ftclib.command.SequentialCommandGroup group = new SequentialCommandGroup(this);
     ...
     * constructing a new {@link com.arcrobotics.ftclib.command.ParallelDeadlineGroup} explicitly.
     *
     * <p>Note: This decorator works by composing this command within a CommandGroup.  The command
     * cannot be used independently after being decorated, or be re-decorated with a different
     * decorator, unless it is manually cleared from the list of grouped commands with
     ...
     * @return the decorated command
     */
    default com.arcrobotics.ftclib.command.Command deadlineWith(com.arcrobotics.ftclib.command.Command... parallel) {
     ...
     * {@link com.arcrobotics.ftclib.command.ParallelCommandGroup} explicitly.
     *
     * <p>Note: This decorator works by composing this command within a CommandGroup.  The command
     * cannot be used independently after being decorated, or be re-decorated with a different
     * decorator, unless it is manually cleared from the list of grouped commands with
     ...
     * @return the decorated command
     */
    default com.arcrobotics.ftclib.command.Command alongWith(com.arcrobotics.ftclib.command.Command... parallel) {
        com.arcrobotics.ftclib.command.ParallelCommandGroup group = new ParallelCommandGroup(this);
     ...
     * command ends.  Often more convenient/less-verbose than constructing a new
     * {@link com.arcrobotics.ftclib.command.ParallelRaceGroup} explicitly.
     *
     * <p>Note: This decorator works by composing this command within a CommandGroup.  The command
     * cannot be used independently after being decorated, or be re-decorated with a different
     * decorator, unless it is manually cleared from the list of grouped commands with
     ...
     * @return the decorated command
     */
    default com.arcrobotics.ftclib.command.Command raceWith(com.arcrobotics.ftclib.command.Command... parallel) {
        com.arcrobotics.ftclib.command.ParallelRaceGroup group = new ParallelRaceGroup(this);
        group.addCommands(parallel);
        return group;
    }
     ...
     * cannot be used independently after being decorated, or be re-decorated with a different
     * decorator, unless it is manually cleared from the list of grouped commands with
     * {@link CommandGroupBase#clearGroupedCommand(com.arcrobotics.ftclib.command.Command)}.  The decorated command can, however, be
     * further decorated without issue.
     *
     * @return the decorated command
     */
    default com.arcrobotics.ftclib.command.Command perpetually() {
        return new PerpetualCommand(this);
    }

    /**
     * Decorates this command to run "by proxy" by wrapping it in a {@link com.arcrobotics.ftclib.command.ProxyScheduleCommand}.
     ...
     * @return the decorated command
     */
    default com.arcrobotics.ftclib.command.Command asProxy() {
    ...
    default void schedule(boolean interruptible) {
        com.arcrobotics.ftclib.command.CommandScheduler.getInstance().schedule(interruptible, this);
    }
     ...
     */
    default void cancel() {
        com.arcrobotics.ftclib.command.CommandScheduler.getInstance().cancel(this);
    }
