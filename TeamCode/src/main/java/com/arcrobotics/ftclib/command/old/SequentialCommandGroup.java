 ...
 */
@Deprecated
public abstract class SequentialCommandGroup implements com.arcrobotics.ftclib.command.old.Command {

    private ArrayList<com.arcrobotics.ftclib.command.old.Command> commands;
