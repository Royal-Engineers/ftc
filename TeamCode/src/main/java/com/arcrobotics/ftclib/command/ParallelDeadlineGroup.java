...
public class ParallelDeadlineGroup extends CommandGroupBase {
    ...
    private final Map<com.arcrobotics.ftclib.command.Command, Boolean> m_commands = new HashMap<>();
    private boolean m_runWhenDisabled = true;
    private com.arcrobotics.ftclib.command.Command m_deadline;
     ...
     */
    public ParallelDeadlineGroup(com.arcrobotics.ftclib.command.Command deadline, com.arcrobotics.ftclib.command.Command... commands) {
        m_deadline = deadline;
     ...
     * @param deadline the command that determines when the group ends
     */
    public void setDeadline(com.arcrobotics.ftclib.command.Command deadline) {
        if (!m_commands.containsKey(deadline)) {
            addCommands(deadline);
        }
        m_deadline = deadline;
    ...
    @Override
    public void addCommands(com.arcrobotics.ftclib.command.Command... commands) {
    ...
    public void initialize() {
        for (Map.Entry<com.arcrobotics.ftclib.command.Command, Boolean> commandRunning : m_commands.entrySet()) {
