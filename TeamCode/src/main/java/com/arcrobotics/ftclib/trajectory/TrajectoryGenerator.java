...
public final class TrajectoryGenerator {
    private static final com.arcrobotics.ftclib.trajectory.Trajectory kDoNothingTrajectory =
            new com.arcrobotics.ftclib.trajectory.Trajectory(Arrays.asList(new com.arcrobotics.ftclib.trajectory.Trajectory.State()));
     ...
     */
    @RequiresApi(api = Build.VERSION_CODES.N)
    public static com.arcrobotics.ftclib.trajectory.Trajectory generateTrajectory(
        ...
        return com.arcrobotics.ftclib.trajectory.TrajectoryParameterizer.timeParameterizeTrajectory(points, config.getConstraints(),
