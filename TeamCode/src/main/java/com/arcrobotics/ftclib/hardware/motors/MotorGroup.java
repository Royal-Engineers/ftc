...
/**
 * Allows multiple {@link com.arcrobotics.ftclib.hardware.motors.Motor} objects to be linked together
 * as a single group. Multiple motors will act together.
 *
 * @author Jackson
 */
public class MotorGroup extends com.arcrobotics.ftclib.hardware.motors.Motor implements Iterable<com.arcrobotics.ftclib.hardware.motors.Motor> {

    private final com.arcrobotics.ftclib.hardware.motors.Motor[] group;
     ...
     */
    public MotorGroup(@NonNull com.arcrobotics.ftclib.hardware.motors.Motor leader, com.arcrobotics.ftclib.hardware.motors.Motor... followers) {
        group = new com.arcrobotics.ftclib.hardware.motors.Motor[followers.length + 1];
        group[0] = leader;
    ...
    public List<Double> getSpeeds() {
        return Arrays.stream(group)
                .map(com.arcrobotics.ftclib.hardware.motors.Motor::get)
    ...
    public List<Double> getVelocities() {
        return Arrays.stream(group)
                .map(com.arcrobotics.ftclib.hardware.motors.Motor::getRate)
                .collect(Collectors.toList());
    }

    @NonNull
    @Override
    public Iterator<com.arcrobotics.ftclib.hardware.motors.Motor> iterator() {
    ...
    public List<Double> getPositions() {
        return Arrays.stream(group)
                .map(com.arcrobotics.ftclib.hardware.motors.Motor::getDistance)
                .collect(Collectors.toList());
    }
    ...
    public void setZeroPowerBehavior(ZeroPowerBehavior behavior) {
        for (com.arcrobotics.ftclib.hardware.motors.Motor motor : group) {
    ...
    @Override
    public void disable() {
        for (com.arcrobotics.ftclib.hardware.motors.Motor x : group) {
            x.disable();
        }
    }
