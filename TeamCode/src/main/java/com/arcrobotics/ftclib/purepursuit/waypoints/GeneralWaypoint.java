...
public class GeneralWaypoint extends Pose2d implements Waypoint {
     ...
     */
    public com.arcrobotics.ftclib.purepursuit.waypoints.GeneralWaypoint setMovementSpeed(double movementSpeed) {
     ...
     * @return This GeneralWaypoint, used for chaining methods.
     */
    public com.arcrobotics.ftclib.purepursuit.waypoints.GeneralWaypoint setTurnSpeed(double turnSpeed) {
     ...
     * @return This GeneralWaypoint, used for chaining methods.
     */
    public com.arcrobotics.ftclib.purepursuit.waypoints.GeneralWaypoint setFollowRadius(double followRadius) {
        this.followRadius = followRadius;
        return this;
    }
     ...
     * @return This GeneralWaypoint, used for chaining methods.
     */
    public com.arcrobotics.ftclib.purepursuit.waypoints.GeneralWaypoint setPreferredAngle(double angle) {
        usePreferredAngle = true;
     ...
     * @return This GeneralWaypoint, used for chaining methods.
     */
    public com.arcrobotics.ftclib.purepursuit.waypoints.GeneralWaypoint setTimeout(long timeoutMiliseconds) {
     ...
     * @return This GeneralWaypoint, used for chaining methods.
     */
    public com.arcrobotics.ftclib.purepursuit.waypoints.GeneralWaypoint disablePreferredAngle() {
        usePreferredAngle = false;
        preferredAngle = 0;
        return this;
    }
    ...
    public void inherit(Waypoint waypoint) {
        if (!copyMode)
            return;
        if (!(waypoint instanceof com.arcrobotics.ftclib.purepursuit.waypoints.GeneralWaypoint))
            throw new IllegalArgumentException("A " + getType() + " waypoint cannot inherit the configuration of a " + waypoint.getType() + " waypoint.");
        com.arcrobotics.ftclib.purepursuit.waypoints.GeneralWaypoint w = (com.arcrobotics.ftclib.purepursuit.waypoints.GeneralWaypoint) waypoint;
