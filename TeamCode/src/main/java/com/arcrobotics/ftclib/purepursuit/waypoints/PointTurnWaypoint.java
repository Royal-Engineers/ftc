...
public class PointTurnWaypoint extends GeneralWaypoint {
     ...
     */
    public com.arcrobotics.ftclib.purepursuit.waypoints.PointTurnWaypoint setPositionBuffer(double buffer) {
     ...
     * @return This PointTurnWaypoint, used for chaining methods.
     */
    public com.arcrobotics.ftclib.purepursuit.waypoints.PointTurnWaypoint setRotationBuffer(double buffer) {
