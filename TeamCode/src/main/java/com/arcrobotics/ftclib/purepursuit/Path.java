 ...
 * @version 1.3
 * @see com.arcrobotics.ftclib.purepursuit.Waypoint
 */
@SuppressWarnings("serial")
public class Path extends ArrayList<com.arcrobotics.ftclib.purepursuit.Waypoint> {

    // The default motion profile.
    private static com.arcrobotics.ftclib.purepursuit.PathMotionProfile defaultMotionProfile = null;
     ...
     */
    public static void setDefaultMotionProfile(com.arcrobotics.ftclib.purepursuit.PathMotionProfile profile) {
    ...
    // Motion profile.
    private com.arcrobotics.ftclib.purepursuit.PathMotionProfile motionProfile;

    // Timeout fields.
    private long timeoutMiliseconds;
    private long timeSinceStart;
    private com.arcrobotics.ftclib.purepursuit.Waypoint lastWaypoint;
     ...
     */
    public Path() {
        this(new com.arcrobotics.ftclib.purepursuit.Waypoint[]{});
    }
     ...
     */
    public Path(com.arcrobotics.ftclib.purepursuit.Waypoint... waypoints) {
        for (com.arcrobotics.ftclib.purepursuit.Waypoint waypoint : waypoints)
            add(waypoint);
    ...
    public double[] loop(double vPosition, double hPosition, double rotation) {
        ...
        for (int i = 1; i < size(); i++) {
            ...
            List<Translation2d> points = com.arcrobotics.ftclib.purepursuit.PurePursuitUtil.lineCircleIntersection(robotPosition, radius, linePoint1, linePoint2);
    ...
    private double[] retrace(double xPosition, double yPosition, double rotation) {
        ...
        double[] motorPowers = com.arcrobotics.ftclib.purepursuit.PurePursuitUtil.moveToPosition(xPosition, yPosition, rotation, lastKnownIntersection.getX(), lastKnownIntersection.getY(), rotation, false);
                ...
                if (!ptwaypoint.hasTraversed()) {
                    ...
                    if (!(bestIntersection.taggedPoint instanceof PointTurnWaypoint))
                        ...
                        if (bestIntersection.waypointIndex < intersection.waypointIndex)
                            ...
                            if (com.arcrobotics.ftclib.purepursuit.PurePursuitUtil.isInFront(get(intersection.waypointIndex - 1).getPose().getTranslation(), intersection.taggedPoint.getPose().getTranslation(), intersection.intersection, bestIntersection.intersection))
                                bestIntersection = intersection;
                    }
                }
    ...
    private double[] handleGeneralIntersection(TaggedIntersection intersection, Pose2d robotPos) {
        ...
        double[] motorPowers = com.arcrobotics.ftclib.purepursuit.PurePursuitUtil.moveToPosition(cx, cy, ca, tx, ty, ta, false);
        // Return motor speeds.
        return motorPowers;
    }
    ...
    private double[] handlePointTurnIntersection(TaggedIntersection intersection, Pose2d robotPos) {
        ...
        double ta;
        double[] motorPowers;
        if (!waypoint.hasTraversed() && com.arcrobotics.ftclib.purepursuit.PurePursuitUtil.positionEqualsWithBuffer(robotPos.getTranslation(), waypoint.getTranslation(), waypoint.getPositionBuffer())) {
            // If the robot has not reached the point.
            if (((GeneralWaypoint) get(intersection.waypointIndex + 1)).usingPreferredAngle()) {
                if (com.arcrobotics.ftclib.purepursuit.PurePursuitUtil.rotationEqualsWithBuffer(robotPos.getHeading(), ((GeneralWaypoint) get(intersection.waypointIndex + 1)).getPreferredAngle(), waypoint.getRotationBuffer()))
                ...
                if (com.arcrobotics.ftclib.purepursuit.PurePursuitUtil.rotationEqualsWithBuffer(robotPos.getHeading(), ta, waypoint.getRotationBuffer()))
                    // If the robot has reached the point and is at the target angle, then the point is traversed.
                    waypoint.setTraversed();
            }
            motorPowers = com.arcrobotics.ftclib.purepursuit.PurePursuitUtil.moveToPosition(cx, cy, ca, tx, ty, ta, true);
        } else {
            if (waypoint.usingPreferredAngle())
                // If this waypoint has a preferred angle, use it instead of the calculated angle.
                ta = (waypoint.getPreferredAngle());
                ...
                // Calculate the target angle.
                ta = Math.atan2(ty - cy, tx - cx);
            motorPowers = com.arcrobotics.ftclib.purepursuit.PurePursuitUtil.moveToPosition(cx, cy, ca, tx, ty, ta, false);
        }
        // Return motor speeds.
        return motorPowers;
    }
    ...
    private double[] handleInterruptIntersection(TaggedIntersection intersection, Pose2d robotPos) {
        ...
        if (!waypoint.hasTraversed() && com.arcrobotics.ftclib.purepursuit.PurePursuitUtil.positionEqualsWithBuffer(robotPos.getTranslation(), waypoint.getTranslation(), waypoint.getPositionBuffer())) {
            ...
            if (waypoint.getType() == WaypointType.END) {
                if (waypoint.usingPreferredAngle() && !com.arcrobotics.ftclib.purepursuit.PurePursuitUtil.rotationEqualsWithBuffer(robotPos.getHeading(), waypoint.getPreferredAngle(), waypoint.getRotationBuffer()))
                    ta = waypoint.getPreferredAngle();
                else {
     ...
     */
    public com.arcrobotics.ftclib.purepursuit.Path setPathTimeout(long timeoutMiliseconds) {
     ...
     * @return This path, used for chaining methods.
     */
    public com.arcrobotics.ftclib.purepursuit.Path setPathType(PathType pathType) {
     ...
     */
    public com.arcrobotics.ftclib.purepursuit.Path setMotionProfile(com.arcrobotics.ftclib.purepursuit.PathMotionProfile profile) {
        if (profile == null)
     ...
     * @return This path, used for chaining methods.
     */
    public com.arcrobotics.ftclib.purepursuit.Path setWaypointTimeouts(long... timeouts) {
     ...
     * @return This path, used for chaining methods.
     */
    public com.arcrobotics.ftclib.purepursuit.Path setWaypointTimeouts(long timeout) {
        for (com.arcrobotics.ftclib.purepursuit.Waypoint waypoint : this)
     ...
     * @return This path, used for chaining methods.
     */
    public com.arcrobotics.ftclib.purepursuit.Path setRetraceSettings(double movementSpeed, double turnSpeed) {
     ...
     * @return This path, used for chaining methods.
     */
    public com.arcrobotics.ftclib.purepursuit.Path resetTimeouts() {
        timedOut = false;
        lastWaypointTimeStamp = System.currentTimeMillis();
        return this;
    }
     ...
     * @return This path, used for chaining methods.
     */
    public com.arcrobotics.ftclib.purepursuit.Path enableRetrace() {
        retraceEnabled = true;
        return this;
    }
     ...
     * @return This path, used for chaining methods.
     */
    public com.arcrobotics.ftclib.purepursuit.Path disableRetrace() {
     ...
     * @return This path, used for chaining methods.
     */
    public com.arcrobotics.ftclib.purepursuit.Path addTriggeredActions(TriggeredAction... actions) {
     ...
     * @return This path, used for chaining methods.
     */
    public com.arcrobotics.ftclib.purepursuit.Path removeTriggeredAction(TriggeredAction action) {
     ...
     * @return This path, used for chaining methods.
     */
    public com.arcrobotics.ftclib.purepursuit.Path clearTriggeredActions() {
     ...
     */
    private com.arcrobotics.ftclib.purepursuit.PathMotionProfile getDefaultMotionProfile() {
    ...
    private static class TaggedIntersection {
        ...
        public com.arcrobotics.ftclib.purepursuit.Waypoint taggedPoint;
