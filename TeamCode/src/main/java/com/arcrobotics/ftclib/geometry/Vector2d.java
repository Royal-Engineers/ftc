...
public class Vector2d {
    ...
    public Vector2d(com.arcrobotics.ftclib.geometry.Vector2d other) {
        m_x = other.getX();
        m_y = other.getY();
    }
     ...
     */
    public com.arcrobotics.ftclib.geometry.Vector2d rotateBy(double angle) {
        angle = Math.toRadians(angle);
        double cosA = Math.cos(angle);
        double sinA = Math.sin(angle);
        double x = m_x * cosA - m_y * sinA;
        double y = m_x * sinA + m_y * cosA;
        return new com.arcrobotics.ftclib.geometry.Vector2d(x, y);
    }
     ...
     */
    public com.arcrobotics.ftclib.geometry.Vector2d plus(com.arcrobotics.ftclib.geometry.Vector2d other) {
        return new com.arcrobotics.ftclib.geometry.Vector2d(m_x + other.m_x, m_y + other.m_y);
    }
     ...
     */
    public com.arcrobotics.ftclib.geometry.Vector2d minus(com.arcrobotics.ftclib.geometry.Vector2d other) {
     ...
     */
    public com.arcrobotics.ftclib.geometry.Vector2d unaryMinus() {
        return new com.arcrobotics.ftclib.geometry.Vector2d(-m_x, -m_y);
    }
     ...
     */
    public com.arcrobotics.ftclib.geometry.Vector2d times(double scalar) {
        return new com.arcrobotics.ftclib.geometry.Vector2d(m_x * scalar, m_y * scalar);
    }
     ...
     * @return the new scaled vector
     */
    public com.arcrobotics.ftclib.geometry.Vector2d div(double scalar) {
        return new com.arcrobotics.ftclib.geometry.Vector2d(m_x / scalar, m_y / scalar);
    }
     ...
     */
    public double dot(com.arcrobotics.ftclib.geometry.Vector2d other) {
     ...
     */
    public double scalarProject(com.arcrobotics.ftclib.geometry.Vector2d other) {
     ...
     */
    public com.arcrobotics.ftclib.geometry.Vector2d scale(double scalar) {
        return new com.arcrobotics.ftclib.geometry.Vector2d(m_x * scalar, m_y * scalar);
    }
     ...
     */
    public com.arcrobotics.ftclib.geometry.Vector2d normalize() {
     ...
     */
    public com.arcrobotics.ftclib.geometry.Vector2d project(com.arcrobotics.ftclib.geometry.Vector2d other) {
    ...
    public boolean equals(Object obj) {
        if (obj instanceof com.arcrobotics.ftclib.geometry.Vector2d) {
            return Math.abs(((com.arcrobotics.ftclib.geometry.Vector2d) obj).getX() - m_x) < 1E-9
                    && Math.abs(((com.arcrobotics.ftclib.geometry.Vector2d) obj).getY() - m_y) < 1E-9;
        }
        return false;
    }
