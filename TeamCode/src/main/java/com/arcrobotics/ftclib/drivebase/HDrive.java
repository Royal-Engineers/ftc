 ...
 * Holonomic drivebase
 */
public class HDrive extends com.arcrobotics.ftclib.drivebase.RobotDrive {
    Motor[] motors;
    ...
    /**
     * Sets the range of the input, see {@link com.arcrobotics.ftclib.drivebase.RobotDrive} for more info.
     *
